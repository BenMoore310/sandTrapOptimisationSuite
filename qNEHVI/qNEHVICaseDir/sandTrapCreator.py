...
sys.path.insert(0, r"/home/bm424/Projects/sandTrapShapeOptServer")
...
tankBottomSpline = "/home/bm424/Projects/sandTrapShapeOptBenchmarking/qNEHVI/spline.txt"
...
Extrusion_4_step_1 = geompy.ImportSTEP(
    "/home/bm424/Projects/sandTrapShapeOptBenchmarking/qNEHVI/cuttingFiles/Extrusion_4.step",
    False,
    True,
)
Extrusion_2_step_1 = geompy.ImportSTEP(
    "/home/bm424/Projects/sandTrapShapeOptBenchmarking/qNEHVI/cuttingFiles/Extrusion_2.step",
    False,
    True,
)
Extrusion_3_step_1 = geompy.ImportSTEP(
    "/home/bm424/Projects/sandTrapShapeOptBenchmarking/qNEHVI/cuttingFiles/Extrusion_3.step",
    False,
    True,
)
Extrusion_1 = geompy.MakePrismVecH2Ways(Face_1, OY, 0.5)
Cut_1 = geompy.MakeCutList(
    Extrusion_1, [Extrusion_4_step_1, Extrusion_2_step_1, Extrusion_3_step_1], True
)
...
inletStep = geompy.ImportSTEP(
    "/home/bm424/Projects/sandTrapShapeOptBenchmarking/qNEHVI/cuttingFiles/inlet.step",
    False,
    True,
)
freeSurfaceStep = geompy.ImportSTEP(
    "/home/bm424/Projects/sandTrapShapeOptBenchmarking/qNEHVI/cuttingFiles/free_surface.step",
    False,
    True,
)
outletStep = geompy.ImportSTEP(
    "/home/bm424/Projects/sandTrapShapeOptBenchmarking/qNEHVI/cuttingFiles/outlet.step",
    False,
    True,
)
...
NETGEN_2D_Parameters_1 = smesh.CreateHypothesisByAverageLength(
    "NETGEN_Parameters_2D", "NETGENEngine", 0.05, 0
)
...
walls = wholeGeo.GetMesh().CutListOfGroups(
    [walls_2], [outlet_2, inlet_2, free_surface_2], "walls"
)


try:
    wholeGeo.ExportSTL(
        r"/home/bm424/Projects/sandTrapShapeOptBenchmarking/qNEHVI/qNEHVICaseDir/surfaceMeshSTLs/inlet.stl",
        1,
        inlet_2,
    )
    pass
...
try:
    wholeGeo.ExportSTL(
        r"/home/bm424/Projects/sandTrapShapeOptBenchmarking/qNEHVI/qNEHVICaseDir/surfaceMeshSTLs/outlet.stl",
        1,
        outlet_2,
    )
    pass
...
try:
    wholeGeo.ExportSTL(
        r"/home/bm424/Projects/sandTrapShapeOptBenchmarking/qNEHVI/qNEHVICaseDir/surfaceMeshSTLs/free_surface.stl",
        1,
        free_surface_2,
    )
    pass
...
try:
    wholeGeo.ExportSTL(
        r"/home/bm424/Projects/sandTrapShapeOptBenchmarking/qNEHVI/qNEHVICaseDir/surfaceMeshSTLs/walls.stl",
        1,
        walls,
    )
    pass
